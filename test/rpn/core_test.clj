...
(facts "About reverse polish notation calculator"
       ...
       (fact "When an alpha character is sent it throws an error"
             (calculator "a") => (throws AssertionError)
             (calculator "Z") => (throws AssertionError)
             (calculator "P") => (throws AssertionError))
       ...
       (fact "When the expression constains an alpha it throws an error"
             (calculator "1 a") => (throws AssertionError)
             (calculator "a 1") => (throws AssertionError)
             (calculator " 1 a ") => (throws AssertionError))
       ...
       (fact "When a + operation is not sent after two numbers it throws an error"
             (calculator "+") => (throws AssertionError)
             (calculator "2 +") => (throws AssertionError)
             (calculator "1 + 2") => (throws AssertionError))
       (fact "When a - operation is sent after two numbers it should display the result"
             (calculator "2 1 -") => "1"
             (calculator "9 2 - 1 -") => "6"
       ...
       (fact "When a - operation is not sent after two numbers it throws an error"
             (calculator "-") => (throws AssertionError)
             (calculator "2 -") => (throws AssertionError)
             (calculator "2 - 1") => (throws AssertionError))
       (fact "When a * operation is sent after two numbers it should display the result"
             (calculator "3 2 *") => "6"
             (calculator "9 2 * 3 *") => "54"
